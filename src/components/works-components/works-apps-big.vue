...
.conteiner.worksApps.public_margin
    ...
    .worksApps__content.public_margin 
        ...
        +CreatCard("@/static/image/fler.jpg","HTML CSS","Frelanser","Описание: Адаптивный ","Live <~>",true,"Cached >=", "https://xarn0.github.io/work8/")   
        +CreatCard("@/static/image/work8.jpg","HTML CSS","Sage","Описание: Адаптивный","Live <~>",true,"Cached >=", "https://xarn0.github.io/Maket/")  
